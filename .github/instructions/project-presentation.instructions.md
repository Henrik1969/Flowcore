---
applyTo: "README.md,Lyraform/README.md,docs/index.md,docs/presentation/**"
---
...
- Link important claims to the checkpoint or architecture document that proves
  or defines them.
- Clearly label future direction. Lyraform is not self-hosted and
  FlowOpenOffice has not been ported.
