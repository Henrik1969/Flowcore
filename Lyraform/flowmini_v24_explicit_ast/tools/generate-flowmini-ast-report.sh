...
#
#       Lyraform/flowmini_v24_explicit_ast/tools/generate-flowmini-ast-report.sh
#
# Usage:
#   cd ~/Projekter/scratchpad/flow_Policy_envelope_pattern/Lyraform/flowmini_v24_explicit_ast
#   tools/generate-flowmini-ast-report.sh
#
# Optional env:
#   FLOWMINI_ROOT=/path/to/Lyraform/flowmini_v24_explicit_ast
