...
fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/ast/target_projection_probe.flow"
test -x "$flowmini"
test -x "$bin"
...
call_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/ast/call_expression_probe.flow"
...
parallel_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/ast/parallel_independence_probe.flow"
...
refined_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/ast/refined_contract_probe.flow"
...
abi_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_libc_demo.flow"
...
struct_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_struct_demo.flow"
...
kernel_clock_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_clock_main.flow"
...
kernel_random_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_random_main.flow"
...
kernel_uname_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_uname_main.flow"
...
kernel_openat_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_openat_main.flow"
...
kernel_read_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_read_main.flow"
...
kernel_write_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_write_main.flow"
...
kernel_lseek_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_lseek_main.flow"
...
kernel_unlinkat_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_unlinkat_main.flow"
...
rmdir_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_rmdir_main.flow"
...
for kernel_name in fork socket listen unshare sethostname pipe2 waitpid socketpair bind poll accept4 connect gethostname; do
    kernel_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/pass/abi_kernel_${kernel_name}_main.flow"
...
bad_field_fixture="$root/Flowmini/flowmini_v29_reusable_native_chain/examples/fail/bad_record_no_such_field.flow"
set +e
