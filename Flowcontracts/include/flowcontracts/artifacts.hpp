...
struct SemanticReport {
    ...
    json::Array abi_type_contracts; json::Array match_facts; json::Array match_operations; json::Array variant_carriers; json::Array enum_types; json::Array parallel_candidates; json::Array parallel_rejections; json::Value lowering_plan; std::size_t proven_pure_count = 0;
...
inline SemanticReport semantic_report(const json::Value& value) {
    ...
    if (const auto* rejections = json::optional(root, "parallel_rejections")) result.parallel_rejections = json::array(*rejections, "$.parallel_rejections");
...
struct ExecutionPlan {
    Header artifact; std::string source_path; json::Array targets; json::Array external_operations;
    json::Array abi_type_contracts; json::Array match_facts; json::Array match_operations;
    json::Array parallel_candidates; json::Array parallel_rejections; json::Value lowering_plan; MatrixView dependency_matrix;
};
