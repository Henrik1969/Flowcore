...
| `std/abi/kernel.flow` | Current Flowkernel communication matrix | all 23 symbols resolve through exact effect-aware grants and have individual narrow executable profiles with safe probes | executable boundary verified; 23/23 |
