...
image="$project_dir/artifacts/FlowLFS-v0.1-basis-v2-terminal.qcow2"
serial_log="$project_dir/artifacts/FlowLFS-v0.1-basis-v2-terminal-serial.log"
callback_port=${FLOWLFS_CALLBACK_PORT:-2230}
...
printf 'Launching FlowLFS basis v2 terminal-insulated with QEMU acceleration: %s\n' "$accel"
printf 'Callback phone: ssh://127.0.0.1:%s\n' "$callback_port"
printf 'Serial evidence: %s\n' "$serial_log"
exec qemu-system-x86_64 \
  -name flowlfs-basis-v2-terminal \
