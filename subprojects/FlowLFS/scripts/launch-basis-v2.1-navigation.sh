...
image="$project_dir/artifacts/FlowLFS-v0.1-basis-v2.1-terminal-navigation.qcow2"
serial_log="$project_dir/artifacts/FlowLFS-v0.1-basis-v2.1-terminal-navigation-serial.log"
callback_port=${FLOWLFS_CALLBACK_PORT:-2232}
...
printf 'Launching FlowLFS basis v2.1 with operational navigation: %s\n' "$accel"
printf 'Callback phone: ssh://127.0.0.1:%s\n' "$callback_port"
exec qemu-system-x86_64 \
  -name flowlfs-basis-v2.1-navigation \
