...
int main(void){arithmetic_and_control();more_arithmetic();comparisons_and_terminals();handles();expected_traps();unresolved_import();isa_v2_execution_inputs();invalid_artifacts();puts("TinyVM typed ISA conformance passed");return 0;}
